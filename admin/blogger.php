...
if ($action == '') {
    ...
    if ($photo) {
        ...
        $icon = '<img src="./views/app/img/avatar.jpg" />';
    }
...
if ($action == 'update') {
    ...
    $User_Model->updateUser(array('nickname'=>$nickname, 'email'=>$email, 'photo'=>$usericon, 'description'=>$description,'website'=>$website), UID);
