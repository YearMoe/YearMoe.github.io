...
<div class=" form-group form-inline" >标&ensp; &nbsp题
                                    <input type="text" name="title" class="form-control" value="<?php echo $customWgTitle['random_log']; ?>"  /></div>
<div class=" form-group form-inline" >显示数
                                    <input class="form-control" maxlength="5" size="10" value="<?php echo Option::get('index_randlognum'); ?>" name="index_ randlognum" /> <input type="submit" name="" value="更改" class="btn btn-primary btn-sm" /></div>
                                </form>
                            </div>
                        </div>
                    </div>
