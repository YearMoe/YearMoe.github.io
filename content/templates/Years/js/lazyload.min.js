...
(function($) {
    ...
    $('.sidebar .YearMoe_post_author .authors_profile .avatar').lazyload({
        event: 'scrollstop',
    });
	...
	$('.widget_YearMoe_hotpost li .thumbnail').lazyload({
        event: 'scrollstop',
    });
	$('.widget_YearMoe_mostviews li .thumbnail').lazyload({
        event: 'scrollstop',
    });
	$('.recent-posts-widget li .thumbnail').lazyload({
        event: 'scrollstop',
    });
	$('.widget_YearMoe_comment ul li .meta .avatar .avatar').lazyload({
        event: 'scrollstop',
    });
