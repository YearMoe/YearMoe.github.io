...
jQuery(document).ready(function($) {
    ...
    */
	...
	$.fn.postLike = function() {
	 ...
	 $.post(YearMoe_url.url_ajax, ajax_data,
	 function(data) {
...
jQuery(document).ready(function(){
    if( jQuery('#upimg').length > 0 ){
        jQuery("#upimg").wrap("<form id='imgupload' action='"+YearMoe_url.url_ajax+"'  method='post' enctype='multipart/form-data'></form>");
