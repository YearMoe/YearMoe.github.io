...
<body class="home blog off-canvas-nav-left">
    ...
    <img style="position:fixed;" src="<?php echo $headimg; ?>" height="100%" width="100%" />
</div>
...
<li><span class="time"><?php echo date('n月j日',$value['date']);?></span><a  target="_blank" href="<?php echo BLOG_URL.'t';?>"><?php echo preg_replace("/\[F(([1-4]?[0-9])|50)\]/",'<img alt="face" src="'.TEMPLATE_URL.'img/face/$1.gif"  />',$value['t']);echo $img;?></a></li>
<?php endforeach; ?> 		
