...
?>
<div class="widget YearMoe_social">
    <h3><span>关注我们 么么哒！</span></h3>
    <div class="attentionus">
		<ul class="items clearfix">
		<span class="social-widget-link social-link-weibo"> 
		<span class="social-widget-link-count"><i class="icon-weibo"></i><?php echo $weibotime; ?></span> 
		<span class="social-widget-link-title">新浪微博</span> 
		<a href="<?php echo $weibourl; ?>" target="_blank" rel="nofollow"></a>
		</span>
			
		<span class="social-widget-link social-link-tencent-weibo"> 
		<span class="social-widget-link-count"><i class="icon-tencent-weibo"></i><?php echo $Txweibo; ?></span> 
		<span class="social-widget-link-title">腾讯微博</span> 
		<a href="<?php echo $Txweibourl; ?>" target="_blank" rel="nofollow"></a> 
		</span>
