...
class LoginAuth{
    ...
    public static function loginPage($errorCode = NULL) {
        ...
        $ckcode = "<div class=\"input-group m-b-20\">
        <span class=\"input-group-addon\"><i class=\"zmdi zmdi-shield-security\"></i></span>
		<div class=\"fg-line form-inline\">
        <input name=\"imgcode\" id=\"imgcode\" class=\"form-control\" type=\"text\" style=\"width:100px\" placeholder=\"验证码\" /> <img src=\"../include/lib/checkcode.php\" align=\"absmiddle\" style=\"position:relative; padding-top:-10px;z-index:99px;cursor:pointer;\" alt=\"未显示?请点击刷新\" title=\"看不清楚？请点击刷新\" onclick=\"this.src=this.src+'?'\" />
        </div></div>" :
        $ckcode = '';
        $error_msg = '';
        if ($errorCode) {
